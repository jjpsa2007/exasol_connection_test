        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, this.sendCommand({
                        ...
                        var password = KJUR.crypto.Cipher.encrypt((_a = _this.config.password) !== null && _a !== void 0 ? _a : '', key, 'RSA');
...
export { AbortQueryCommand, ClosePreparedStatementCommand, CloseResultSetCommand, ColumnsCommand, Command, Connection, CreatePreparedStatementCommand, DisconnectCommand, ErrClosed, ErrInvalidConn, ErrInvalidCredentials, ErrInvalidValuesCount, ErrJobAlreadyRunning, ErrLoggerNil, ErrMalformedData, ExasolDriver, ExecutePreparedStatementCommand, FetchCommand, FunctionsCommand, LoginSQLCommand, LoginTokenSQLCommand, RolesCommand, SQLBatchCommand, SQLSingleCommand, SchemasCommand, ScriptsCommand, SetAttributesCommand, Statement, TablesCommand, UsersCommand, driverVersion, newInvalidHostRangeLimits, newInvalidReturnValueResultSet, newInvalidReturnValueRowCount, newPoolSizeErr };
